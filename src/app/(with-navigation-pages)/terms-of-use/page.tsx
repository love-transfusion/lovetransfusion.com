    ...
    <div className={'pb-10 pt-10 lg:pb-[64px] lg:pt-[64px] px-4 lg:px-8'}>
      ...
      >
        ...
        <div className={'text-[#999] flex flex-col gap-4'}>
          ...
          <div className={'flex flex-col gap-1'}>
            <p className={'text-primary font-semibold'}>4. Use of the App</p>
            <p className={''}>
          ...
          <div className={'flex flex-col gap-1'}>
            <p className={'text-primary font-semibold'}>5. User Content</p>
            <p
              className={''}
          ...
          <div className={'flex flex-col gap-1'}>
            <p className={'text-primary font-semibold'}>6. Privacy Policy</p>
            <p className={''}>
              Our{' '}
          ...
          <div className={'flex flex-col gap-1'}>
            <p className={'text-primary font-semibold'}>8. Termination</p>
            <p className={''}>
              We may suspend or terminate your access to the App at any time,
              for any reason, including violation of these Terms or any
              applicable laws. Upon termination, your right to use the App will
          ...
          <div className={'flex flex-col gap-1'}>
            ...
            <p className={''}>
              ...
              the App will be error-free or uninterrupted or that any defects
              will be corrected.
            </p>
          </div>
          <div className={'flex flex-col gap-1'}>
            ...
            <p className={''}>
              To the maximum extent permitted by law, Love Transfusion Inc. will
              not be liable for any damages, including direct, indirect,
              incidental, consequential, or punitive damages, arising out of or
              related to your use or inability to use the App, even if we have
              been advised of the possibility of such damages.
            </p>
          </div>
          <div className={'flex flex-col gap-1'}>
            <p className={'text-primary font-semibold'}>11. Indemnification</p>
            <p className={''}>
              You agree to indemnify and hold harmless Love Transfusion Inc. and
              its officers, directors, employees, and agents from any claims,
              liabilities, damages, or expenses (including legal fees) arising
              out of your use of the App, your User Content, or your violation
              of these Terms.
            </p>
          </div>
          <div className={'flex flex-col gap-1'}>
            ...
            <p className={''}>
              ...
              any part thereof at any time without notice. We may also update
              these Terms from time to time. If we make material changes, we
              will notify you by posting the revised Terms within the App. Your
              continued use of the App after the changes go into effect
          ...
          <div className={'flex flex-col gap-1'}>
            ...
            <p className={''}>
              ...
              law principles. Any disputes arising out of or related to these
              Terms or the use of the App shall be resolved exclusively in the
